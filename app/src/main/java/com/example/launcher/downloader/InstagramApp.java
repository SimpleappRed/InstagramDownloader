...
public class InstagramApp {
    ...
    InstagramApp(final Context context, String clientId, String clientSecret,
                 String callbackUrl) {
        ...
        mAuthUrl = AUTH_URL + "?client_id=" + clientId + "&redirect_uri="
                + mCallbackUrl + "&response_type=code&scope=basic";

        InstagramDialog.OAuthDialogListener listener = new InstagramDialog.OAuthDialogListener() {
            @Override
            public void onComplete(String code) {
                getAccessToken(code);
                Toast.makeText(context,"You logged in, Again click on the Download",Toast.LENGTH_SHORT).show();
            }
